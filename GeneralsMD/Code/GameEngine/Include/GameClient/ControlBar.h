...
//-------------------------------------------------------------------------------------------------
enum { MAX_COMMANDS_PER_SET = 72 };  // user interface max is 14 (but internally it's 18 for script only buttons!)
enum { MAX_RIGHT_HUD_UPGRADE_CAMEOS = 5};
enum {
			 MAX_PURCHASE_SCIENCE_RANK_1 = 5,
			 MAX_PURCHASE_SCIENCE_RANK_3 = 15,
			 MAX_PURCHASE_SCIENCE_RANK_8 = 5,
			};
...
enum { MAX_SPECIAL_POWER_SHORTCUTS = 33};
